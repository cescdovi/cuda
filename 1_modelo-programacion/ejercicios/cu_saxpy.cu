...
int cu_saxpy( const unsigned int n, const unsigned int blocksize, float a, float *h_x, float *h_y ) {
  ...
  int nblocks = /* Cálculo del número de bloques */
...
int main( int argc, char *argv[] ) {
  ...
  cu_saxpy( n, blocksize, a, x, y_gpu );
